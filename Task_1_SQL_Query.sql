...
/* Next step - merge Netsuite and Payment gateways tables with full join */
  ...
  full outer join dbsix.dbo.payments_netsuite b on a.order_ref = b.order_ref  and a.MERCHANT_ACCOUNT = b.MERCHANT_ACCOUNT and a.amount_foreign = b.amount_foreign
